...
function AJAXHEAD(param) {
	var setHhead = { 'content-type': 'application/x-www-form-urlencoded;charset=UTF-8' }
	var _default = {
		"method": "POST",
        "dataType": "json",
        "header":setHhead
	}
    return _extend({}, _default,param);
}
...
Utilities.test = validate;
Utilities.head = AJAXHEAD;
